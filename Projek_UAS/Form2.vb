...
Public Class Form2
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        insertquery = "insert into anggota" & "(Nim, Nama, Kelas ,Jurusan ,No_Hp)" & "values('" & TextBox1.Text & "', " & " ' " & TextBox2.Text & "' , " & " ' " & TextBox3.Text & "' , " & " ' " & TextBox4.Text & "' , " & " ' " & TextBox5.Text & "')"
        Try
            cmd = New OdbcCommand(insertquery, conn)
            cmd.Connection.Open()
            hasil = cmd.ExecuteNonQuery()
            If (hasil > 0) Then MessageBox.Show("Record sukses", "OK", MessageBoxButtons.OK, MessageBoxIcon.Information)
            TextBox1.Text = ""
            TextBox2.Text = ""
            TextBox3.Text = ""
            TextBox4.Text = ""
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        koneksi()
        cmd = New OdbcCommand("DELETE FROM anggota WHERE Nim = '" + TextBox1.Text + "'", conn)
        With cmd
            .ExecuteNonQuery()
            .Dispose()
            DataGridView1.Refresh()
